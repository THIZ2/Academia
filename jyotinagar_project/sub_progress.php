<?php
 session_start();
include("config.php");
$sqlj="Select * from $table where name='".$_SESSION['user_name']."' AND month='january' ";
$runj=mysqli_query($conn,$sqlj);
$dataj=mysqli_fetch_array($runj);

$sqlf="Select * from $table where name='".$_SESSION['user_name']."' AND month='feburary' ";
$runf=mysqli_query($conn,$sqlf);
$dataf=mysqli_fetch_array($runf);

$sqlm="Select * from $table where name='".$_SESSION['user_name']."' AND month='march' ";
$runm=mysqli_query($conn,$sqlm);
$datam=mysqli_fetch_array($runm);

$sqla="Select * from $table where name='".$_SESSION['user_name']."' AND month='august' ";
$runa=mysqli_query($conn,$sqla);
$dataa=mysqli_fetch_array($runa);

$sqls="Select * from $table where name='".$_SESSION['user_name']."' AND month='september' ";
$runs=mysqli_query($conn,$sqls);
$datas=mysqli_fetch_array($runs);

$sqlo="Select * from $table where name='".$_SESSION['user_name']."' AND month='october' ";
$runo=mysqli_query($conn,$sqlo);
$datao=mysqli_fetch_array($runo);

$sqln="Select * from $table where name='".$_SESSION['user_name']."' AND month='november' ";
$runn=mysqli_query($conn,$sqln);
$datan=mysqli_fetch_array($runn);

$sqld="Select * from $table where name='".$_SESSION['user_name']."' AND month='december' ";
